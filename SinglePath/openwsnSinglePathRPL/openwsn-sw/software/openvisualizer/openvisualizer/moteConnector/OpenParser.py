...
import ParserData
import ParserPacket
import ParserStat  # added by Erfan, Fab's stat
...
class OpenParser(Parser.Parser):
    ...
    SERFRAME_MOTE2PC_STAT              = ord('T') # added by Erfan, Fab's stat
    ...
    def __init__(self):
        ...
        self.parserStat      = ParserStat.ParserStat() # added by Erfan, Fab's stat
