...
#ifdef FORCE_PARENT
/**
\breif set primary parent statically, added by Erfan
...
\param[in] havePrimary, primaryIndex
   header.
*/
void schedule_getParents(uint8_t* havePrimary, uint8_t* primaryIndex) {
   bool primary;
   uint8_t i,j;
   open_addr_t address;
   primary=FALSE;
