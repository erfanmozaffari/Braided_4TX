...
*/
#define SLOTFRAME_LENGTH    117 //should be 101
...
// struct to save primary and secondary parents, added by Erfan
typedef struct {
   open_addr_t primaryParent;
   open_addr_t secondaryParent;  
} parents_vars_t;
...
slotOffset_t       schedule_getSlotOffset(void); // added by Erfan, Fab's stat
...
// added by Erfan to load scheduling
void               schedule_loadScheduling(uint8_t startingSlotOffset);
#endif
#ifdef CRASH_NODES
// added by Erfan to load Crashed Nodes
void               schedule_loadCrashStat(void);
#endif
/**
\}
\}
