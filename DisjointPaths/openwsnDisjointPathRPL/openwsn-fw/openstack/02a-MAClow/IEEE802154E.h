...
#define TXRETRIES                    1 // number of MAC retries before declaring failed, changed from 3 to 1, changes by Erfan
#define TX_POWER                    31 // 1=-25dBm, 31=0dBm (max value)
#define RESYNCHRONIZATIONGUARD       5 // in 32kHz ticks. min distance to the end of the slot to successfully synchronize
#define US_PER_TICK                 30 // number of us per 32kHz clock tick
#define EB_PORTION                   1 // The portion of minimal cells that used for sending EB. (changed from 6 to 3 to accelerate dodag sync, added by Erfan)
...
uint8_t            calculateFrequency(uint8_t channelOffset);  // added by Erfan
