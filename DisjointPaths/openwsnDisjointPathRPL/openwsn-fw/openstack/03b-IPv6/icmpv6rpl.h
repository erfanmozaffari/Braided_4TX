...
#define DIO_PORTION               3   // The portion of minimal cells that used for sending DIO. temporarily changed from 6 to 3 by Erfan
...
typedef struct {
   ...
   bool                      secondPreferredParent;   ///< this router has a second route to DAG root, added by Erfan for secondary parent
   uint8_t                   secondParentIndex;       ///< index of second Pref Parent in neighbor table (if secondPrefParent==True), added by Erfan for secondary parent
#endif   
...
#ifdef SECONDARY_PARENT
bool     icmpv6rpl_getSecondPreferredParentEui64(open_addr_t* addressToWrite); // func definition for 2nd pref parent, added by Erfan for secondary parent
#endif
