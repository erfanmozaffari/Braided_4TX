...
// enable stats added by Erfan, Fab's stat
...
// debugging option, added by Erfan for disjoint path RPL
//#define DISJOINT_PATH_DEBUG

// disjoint path rpl option, added by Erfan for disjoint path RPL
#define DISJOINT_PATH

#ifdef CRASH_NODES
uint8_t crashedNodes_ID[5];
uint32_t crashedNodes_ASN[5];
#endif
