...
typedef struct {
   ...
   bool                      secondPreferredParent;   ///< this router has a second route to DAG root, added by Erfan for rpl
   uint8_t                   secondParentIndex;       ///< index of second Parent in neighbor table, added by Erfan for rpl
...
bool     icmpv6rpl_getSecondPreferredParentEui64(open_addr_t* addressToWrite); // get second pref parent, added by Erfan for rpl
