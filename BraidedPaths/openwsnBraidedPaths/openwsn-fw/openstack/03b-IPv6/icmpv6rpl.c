...
void icmpv6rpl_init() {
   ...
   icmpv6rpl_vars.secondPreferredParent=FALSE;  // set default as not found, added by Erfan for MCS
#endif
...
// *** function added by Erfan for MCS to get second preferred parent *** //
/**
\brief Retrieve my preferred parent's EUI64 address.
\param[out] addressToWrite Where to copy the preferred parent's address to.
*/
